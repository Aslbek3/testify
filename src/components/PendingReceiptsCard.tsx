...
/**
 * Tasdiq kutayotgan cheklar — direktor va qabulxona AYNI ro'yxatni
 * ko'radi, shuning uchun u komponentda, ikkala sahifada takrorlanmaydi.
 *
 * `canReview` — "Qabulxona pul bilan ishlaydi" kaliti o'chirilgan bo'lsa,
 * qabulxona ro'yxatni ko'raveradi (o'quvchi so'raganda javob berishi
 * kerak), lekin tasdiqlash/rad etish tugmalari chizilmaydi. Haqiqiy
 * cheklov baribir serverda (`canReviewStudentPayments`).
 */
      ...
      {pending.length === 0 ? (
        ...
        <>
          <p className="mb-4 text-sm text-text-muted">
            {canReview
              ? "Chekni oching va kartaga shu summa haqiqatan tushganini tekshiring — tasdiqlash o'quvchi muddatini darhol uzaytiradi."
